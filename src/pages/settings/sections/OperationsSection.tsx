...
export function OperationsSection() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <Panel title="Punctuality" subtitle="On time and too early">
        <FieldGrid>
          <NumberField
            label="On-time grace"
            ...
            step={30}
            suffix="min"
            hint="720 minutes reads as arrival on the promised date."
          />
          <NumberField
            ...
            step={30}
            suffix="min"
            hint="Beyond this, an early arrival is reported separately."
          />
        </FieldGrid>
      </Panel>
      ...
      <Panel title="Targets" subtitle="The marks the gauges draw against">
        <FieldGrid columns={3}>
          ...
          <NumberField
            ...
            max={100}
            suffix="%"
            hint="Share of outbound bookings matching aims to pair."
          />
        </FieldGrid>
      </Panel>

      <Panel title="Empty return" subtitle="Due-soon and risk windows">
        <FieldGrid>
          <NumberField
            ...
            max={240}
            suffix="hours"
            hint="Free time below this reads as due soon."
          />
          <NumberField
            ...
            max={168}
            suffix="hours"
            hint="A live booking arriving inside this window with no full load alerts."
          />
        </FieldGrid>
      </Panel>
      ...
      <Panel
        title="Risk score"
        subtitle="Weights and thresholds"
        action={
          <span
            className={cn(
      ...
      >
        <FieldGrid columns={3}>
          ...
          <NumberField
            ...
            min={0}
            max={100}
            hint="Score at or above which a booking enters the alert table."
          />
          {!weightsBalanced ? (
            <SectionNote tone="warning">
              The three weights must sum to 1. At {weightSum.toFixed(2)} the score no longer runs 0–100.
            </SectionNote>
          ) : null}
        </FieldGrid>
      </Panel>

      <Panel title="Corridor economics" subtitle="Empty-kilometre and emissions inputs">
        <FieldGrid columns={3}>
          <NumberField
            ...
            step={0.01}
            suffix="USD/km"
            hint="Fuel, tyres and wear on an empty return."
          />
          <NumberField
            label="CO₂ loaded"
          ...
          <NumberField
            ...
            step={0.01}
            suffix="kg/km"
            hint="An empty vehicle still burns most of its fuel."
          />
        </FieldGrid>
      </Panel>
    </div>
